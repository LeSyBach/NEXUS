...
// ══════════════════════════════════════════════════════════════
// NEXUS Color Palette - Professional Blue (LinkedIn Inspired)
// ══════════════════════════════════════════════════════════════

// Primary - Professional Blue
val NexusPrimary = Color(0xFF0A66C2)
val NexusPrimaryVariant = Color(0xFF004182)
val NexusPrimaryDark = Color(0xFF004182)
val NexusPrimaryLight = Color(0xFF70B5F9)

// Secondary - Accent Blue
val NexusSecondary = Color(0xFF2C9EE8)
val NexusSecondaryVariant = Color(0xFF1A8CD8)
val NexusSecondaryDark = Color(0xFF0A66C2)

// Accent - Soft Blue
val NexusAccent = Color(0xFF4A90D9)
...
// ── Gradient Colors ──
val GradientStart = Color(0xFF0A66C2)
val GradientMid = Color(0xFF1A8CD8)
val GradientEnd = Color(0xFF2C9EE8)